...
function richmondoval_scripts_styles() {
	...
	//STAGES
	//Scripts
	if(get_page_template_slug() == 'template-stages.php' || get_page_template_slug() == 'template-stages_login.php' || get_page_template_slug() == 'template-stages_registration.php') {
